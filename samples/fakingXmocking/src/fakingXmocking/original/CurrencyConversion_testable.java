...
public final class CurrencyConversion_testable
{
   ...
   public static Map<String, String> currencySymbols()
   {
      ...
      try {
         HttpClient httpClient = httpClientFactory.call();
   ...
   static Callable<HttpClient> httpClientFactory = new Callable<HttpClient>() {
      @Override public HttpClient call() { return new DefaultHttpClient(); }
   };
}
