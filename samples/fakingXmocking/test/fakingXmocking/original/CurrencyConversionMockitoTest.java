...
public final class CurrencyConversionMockitoTest
{
   ...
   Callable<HttpClient> originalFactory;

   @Before
   public void prepareSUT()
   {
      originalFactory = CurrencyConversion_testable.httpClientFactory;
      CurrencyConversion_testable.httpClientFactory = new Callable<HttpClient>() {
         @Override public HttpClient call() { return httpClient; }
      };
   }
