...
@SuppressStaticInitializationFor("powermock.examples.simple.SimpleConfig")
...
public class GreeterTest
{
   ...
   public void testRun() throws Exception
   {
      ...
      logger.log("Hello"); expectLastCall().times(10);
   ...
   {
      expectNew(Logger.class).andThrow(new IllegalArgumentException("Unexpected exception"));
      replay(Logger.class);
