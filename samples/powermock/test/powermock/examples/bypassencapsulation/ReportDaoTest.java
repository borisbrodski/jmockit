...
/**
 * Unit tests for the {@link ReportDao} class. This demonstrates one basic usage of PowerMock's
 * ability to set internal state for a class that is partially mocked.
 */
...
public class ReportDaoTest
{
   ...
   public void testDeleteReport() throws Exception
   {
      ...
      // Mock only the "getReportFromTargetName" method.
      ...
      // Now that we have a mock of the cache we set this instance in the class being tested.
      Whitebox.setInternalState(tested, cacheMock);

      // Create an expectation for the private method "getReportFromTargetName".
